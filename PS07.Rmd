...
Please indicate who you collaborated with on this assignment: Me, myself, and I.
...
library(plotROC)
install.packages(ROCR-master)

glm.out <- glm(SeriousDlqin2yrs ~ DebtRatio, family = binomial, data = train) 

glm.probs <- predict(glm.out, test, type = "response")

pred <- prediction(glm.probs, test$SeriousDlqin2yrs)
